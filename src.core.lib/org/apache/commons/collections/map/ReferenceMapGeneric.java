 ...
 */
public class ReferenceMapGeneric extends AbstractReferenceMap implements Serializable {
     ...
     *   must be {@link #HARD}, {@link #SOFT}, {@link #WEAK}
     */
    public ReferenceMapGeneric(int keyType, int valueType) {
     ...
     */
    public ReferenceMapGeneric(int keyType, int valueType, boolean purgeValues) {
     ...
     */
    public ReferenceMapGeneric(int keyType, int valueType, int capacity, float loadFactor) {
     ...
     *   key is garbage collected 
     */
    public ReferenceMapGeneric(int keyType, int valueType, int capacity,
