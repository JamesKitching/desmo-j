 ...
 */
public class ExcelDebugOutput implements OutputTypeEndToExport
{
	/** CollectionDataSource */
	private ArrayList<HashMap<String, String>> al;

	/** Create a new ExcelDebugOutput class */
	public ExcelDebugOutput()
	{
	...
	{
        String jasperSource = "debug_layout_excel.jasper";
        ...
        try
		{
            ...
            System.out.print("Exporting Debug Channel to Excel, please wait... ");
