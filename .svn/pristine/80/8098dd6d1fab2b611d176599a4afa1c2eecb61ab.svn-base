...
public class Rotation {
	...
	/**
	 * A boolean array to indicate which about which axis the rotation should be.
	 * The first element is for the X-axis, the second for the Y-axis and the last for the Z-axis.
	 */
	 ...
	 * @param axis A 3 elements boolean array to indicate which about which axis the rotation should be.
	 * The elements refer to the axis X,Y and Z. The combination of more than
	 * one axis isn't supported. 
	...
	public Rotation(boolean[] axis, double angle, double duration){
		...
		assert (axis[0]==false&&axis[1]==false&&axis[2]==false):"The axis for the rotation should be specified.";
	 ...
	 * @return A 3 elements boolean array which associate to the X,Y and Z axis the rotation is about. True stands for the rotation about this axis.
	 */
