 ...
 * Queue, this class tests the Queue only. The default implementation with 
 * with the sort order fifo (first in first out) is used.
 * <p>
 ...
 */
public class QueueModulTest extends TestCase
{
