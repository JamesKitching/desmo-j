...
public class ContDistAggregate extends ContDist {
	...
	public void reset() {
		super.reset();
		for (NumericalDist<?> n : this.dists) {
			n.reset();
		}
	}
	...
	public void reset(long newSeed) {
        throw new UnsupportedOperationException(this.getName() + " does not support resetting using a single seed. Please set the seed of all distributions seperately.");
	}
