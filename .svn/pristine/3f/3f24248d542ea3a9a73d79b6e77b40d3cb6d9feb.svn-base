...
public class SpatialData{
	 ...
	 * @param matrixData The spatial data represented with a double[16] matrix. It begins with the first element in the first row, then the second element in the first row etc.
	 */
