...
public abstract class Entity extends Schedulable {
     ...
     * Event are already scheduled in the event-list. No preemption, i.e. a process calling this method
    * will continue until passivated or hold.
     ...
     * No preemption, i.e. a process calling this method
     * will continue until passivated or hold.
     * 
     * @param what
     *            Event : The Event that manipulates this Entity
    ...
    /**
     * Schedules this Entity to be manipulated by the given Event at the current
     * time. Method returns with a warning message if
     * either Entity or Event are already scheduled in the EventList.
     * No preemption, i.e. a process calling this method
     * will continue until passivated or hold.
     * 
...
/**
     ...
     * time plus the given offset. No preemption, i.e. a process calling this method
     * will continue until passivated or hold.
     * 
     * @param who2
     *            Entity : The second entity to be scheduled for the EventOf2Entities.
    ...
    public <E extends Entity, F extends Entity> void schedule(E who2, F who3, EventOf3Entities<?, E, F> what) {
        ...
        if ((who2 == null)) {
            sendWarning("Can't schedule Entity! Command ignored.", "Entity : "
                    + getName() + " Method: <E extends Entity, F extends Entity> schedule(E who2, F who3, EventOf3Entities<?, E, F> what)",
                    "The Entity 'who2' given as parameter is a null reference.",
                    "Be sure to have a valid Entity reference for this event "
                            + "to be scheduled with.");
            return; // no proper parameter
	...
	public void scheduleAfter(Schedulable after, Event<?> what) {
        ...
        // generate trace
        this.generateTraceForScheduling(what, null, null, after, null, after.getEventNotes().get(after.getEventNotes().size()-1).getTime(), null);
	...
	public <E extends Entity> void scheduleAfter(Schedulable after, EventOf2Entities<?, E> what, E who2) {
        ...
        // generate trace
        this.generateTraceForScheduling(what, who2, null, after, null, after.getEventNotes().get(after.getEventNotes().size()-1).getTime(), null);
	...
	public <E extends Entity, F extends Entity> void scheduleAfter(Schedulable after, EventOf3Entities<?, E, F> what, E who2, F who3) {
        ...
        // generate trace
        this.generateTraceForScheduling(what, who2, who3, after, null, after.getEventNotes().get(after.getEventNotes().size()-1).getTime(), null);
     ...
     */
    protected void generateTraceForScheduling(EventAbstract Event, Entity who1, Entity who2, Schedulable after, Schedulable before, TimeInstant at, String remark) {
