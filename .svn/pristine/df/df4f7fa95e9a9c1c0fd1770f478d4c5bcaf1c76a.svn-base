...
public class Truck extends MovableSpatialSimProcess {
	 ...
	 */
	public Truck(ConstructionModel owner, String name, String type,
			boolean showInTrace, double acc, double dec,
			double mSpeed, Length startPositionX, Length startPositionY,
...
//		this.setPosition(startPositionX, startPositionY, startPositionZ);
	 ...
	 * @throws SuspendExecution 
	 */
	public void moveToLoadingPoint(SpatialObject loadingPoint) throws SuspendExecution{
