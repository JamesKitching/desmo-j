...
/**
 * Use this class to create PDF formatted Simulation Error Output.
 * 
 * @version DESMO-J, Ver. 2.5.1e copyright (c) 2017
 * @date 30.03.2011
 * @author Xiufeng Li, Binhua Han, Rene Wecker
 */
public class PdfErrorOutput implements OutputTypeEndToExport
{
	/** CollectionDataSource  */
	private ArrayList<HashMap<String, String>> al;
	
	/** Create a new PdfDebugOutput class */
	public PdfErrorOutput()
	{
	...
	{
        String jasperSource = "error_layout_pdf.jasper";
        ...
        try
		{
            ...
            System.out.print("Exporting Error Channel as PDF, please wait... ");
