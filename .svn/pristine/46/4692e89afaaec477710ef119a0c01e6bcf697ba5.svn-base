...
public class ASCIITableFormatter extends AbstractTableFormatter {
    ...
    /**
     * Allows to disable the table footer. The footer can be problematic for comparisons
     * because it contains information that will change between runs.
     */
    ...
    /**
     * Disables the table footer (for all ASCII tables). The footer can be problematic for comparisons
     * because it contains information that will change between runs.
     */
