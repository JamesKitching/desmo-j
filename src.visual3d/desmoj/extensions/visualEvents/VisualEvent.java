...
public abstract class VisualEvent extends EventObject {
	 ...
	 */
	private TimeInstant _occurredTime;

	/**
	 * The name of the target of the spatial operation.
	 */
	private String _affectedSpatialObjectName;

	/**
	 * Constructs a VisualEvent.
	 * @param source The object on which the event initially occurred.
	 * @param affectedSpatialObjectName The name of the SpatialObject which
	 * is affected by this VisualEvent.
