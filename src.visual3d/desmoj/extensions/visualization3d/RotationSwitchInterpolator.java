 ...
 * It doesn't need much rotational data at the initiation.
 * The alpha, rotation axis and the angles just need to be specified at the
 * start. If the rotation is finished, the calculation will be stopped and the
 * alpha removed.
 * 
 * @author Fred Sun
 *
...
public class RotationSwitchInterpolator extends RotationInterpolator {
	...
	private Transform3D _rotationTransform = new Transform3D();
	private Transform3D _angleTransform = new Transform3D();
	...
	/* (non-Javadoc)
	 * @see javax.media.j3d.RotationInterpolator#computeTransform(float, javax.media.j3d.Transform3D)
	 */
	@Override
	 ...
	 * @param transformAxis the transform that defines the local coordinate
	 * system in which this interpolator operates. The rotation is done about
	 * the Y-axis of this local coordinate system.
	 * @param currentTransform the transform that contains the current
