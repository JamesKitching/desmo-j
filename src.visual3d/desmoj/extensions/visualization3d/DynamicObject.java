 ...
 * </br></br>
 * - a BranchGroup for attach/detach it to/from nodes</br>
 * - a BranchGroup which contains the 3D-model</br>
 * - a TransformGroup which's responsible for the positioning</br>
 * - a TransformGroup which's responsible for the orientation</br>
 * - a MovementPathInterpolator to move the object in time</br>
 * - a Rotation to rotate the object in time</br>
 * 
 * @author Fred Sun
 *
 */
public class DynamicObject {
	...
	private BranchGroup _detachBranch;
	
	//the BranchGroup which contains the 3D-model
	private BranchGroup _modelBranch;
	
	//the TransformGroup for the translation
	private TransformGroup _positionTransform;
	
	//the TransformGroup for the rotation
	private TransformGroup _orientationTransform;
	
	//a Interpolator to move the object
	private MovementPathInterpolator _moveInterpolator;
	
	//a Interpolator to rotate the object
	private RotationSwitchInterpolator _rotateInterpolator;
	 ...
	 * @param clock The VisualizatinoClock from the VisualizationControl object
	 * to initiate the interpolator's and VisualizatinoClockAlpha.
	 */
	 ...
	 * @param nextRoot The root BranchGroup this object will be added to after
	 * the detaching.
	 */
	...
	/**
	 * Gets the interpolator which is responsible for the translational
	 * movements.
	 * @return the the interpolator which is responsible for the translational
	 * movements
	 */
	...
	/**
	 * Gets the interpolator which is responsible for the rotational
	 * movements.
	 * @return the interpolator which is responsible for the rotational
	 * movements
	 */
	 ...
	 * @return the host object this object is attached to. Null, if this object
	 * isn't attached to any object.
	 */
