 ...
 * It's the connector between the Visualevent-Producer and the VisualMudules.
 * Each VisualModule is a different visualization implementation.
 * The VisualModule to be used should be registered in the VisualizationControler.
 * The controller will forward the events to each registered module.
 * 
 * @author Fred Sun
 *
 */
public class VisualizationControl implements VisualEventListener{
	...
	private HashMap<String,VisualModule> _modules;
	...
	/**
	 * Gets a registered VisualModule with the given name. If no registered with the name can
	 * be found, null will be returned.
	 * @param name The name of the registered VisualModule to be get.
	 * @return The VisualModule with the name in this VisualizationControl.
	 ...
	 * @param speed The execution speed rate. If the rate is <= 0, the
	 * clock will keep running with the old speed.
	 */
