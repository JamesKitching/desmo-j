 ...
 * </br>
 * The speed of the clock can be changed through a speed
 * rate
 * </br>
 * The influence of the rate to the clock speed is:</br>
...
public class VisualizationClock {
	...
	/**
	 * Sets the speed rate, which influence the clock speed with:</br>
	 * clock speed = system clock speed * speed rate
