...
//		}
	 ...
	 */
	public void move(SpatialObject destination, String entryPointName, TimeSpan duration, boolean focusOnTrack) throws SuspendExecution {
		if(_isAttached){
			ErrorMessage eMessage = new ErrorMessage(this.getModel(),
					"The object can't be moved.",
...
//		}
	 ...
	 */
	public void move(SpatialObject destination, String entryPointName, TimeSpan duration, double maxSpeed, double acc, double dec, boolean focusOnTrack) throws SuspendExecution {
		if(_isAttached){
			ErrorMessage eMessage = new ErrorMessage(this.getModel(),
					"The object can't be moved.",
