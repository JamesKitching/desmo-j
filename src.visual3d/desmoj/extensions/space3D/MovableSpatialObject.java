...
//	public abstract boolean isChildMSO();
	 ...
	 */
	public abstract void move(SpatialObject destination, String entryPointName, boolean focusOnTrack) throws SuspendExecution;
	 ...
	 * @param focusOnTrack Whether the orientation of the moving object should focus to the moving direction.
	 */
	public abstract void move(SpatialObject destination, String entryPointName, TimeSpan duration, boolean focusOnTrack) throws SuspendExecution ;
	 ...
	 * @param focusOnTrack Whether the orientation of the moving object should focus to the moving direction.
	 */
	public abstract void move(SpatialObject destination, String entryPointName, TimeSpan duration, double maxSpeed, double acc, double dec, boolean focusOnTrack)  throws SuspendExecution;
	 ...
	 * @param focusOnTrack Whether the orientation of the moving object should focus to the moving direction.
	 */
	public abstract void move(Movement movement, boolean focusOnTrack) throws SuspendExecution ;
	 ...
	 */
	public abstract void notifyMovingDone() throws SuspendExecution;

	/**
	 * Notifies the MovableSpatialObject that the rotating is finished and updates the new coordinates.
	 * This method shouldn't be called by user!
	 */
	public abstract void notifyRotatingDone() throws SuspendExecution;
	 ...
	 */
	public abstract void rotX(double angle, TimeSpan duration) throws SuspendExecution;
	 ...
	 * @param duration The duration of the animation
	 */
	public abstract void rotY(double angle, TimeSpan duration) throws SuspendExecution;
	 ...
	 * @param duration The duration of the animation
	 */
	public abstract void rotZ(double angle, TimeSpan duration) throws SuspendExecution;
