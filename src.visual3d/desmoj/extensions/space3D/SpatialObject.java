...
public interface SpatialObject {
	 ...
	 */
	public abstract void addEntryPoint(String name, Length xPos, Length yPos, Length zPos);
	 ...
	 */
	public abstract void addExitPoint(String name, Length xPos, Length yPos, Length zPos);
	 ...
	 */
	public abstract Length[] getEntryPoint(String name);
	 ...
	 */
	public abstract Length[] getEntryPointGlobal(String name);
	 ...
	 */
	public abstract Length[] getExitPoint(String name);
	 ...
	 */
	public abstract Length[] getExitPointGlobal(String name);
	 ...
	 */
	public abstract void setPosition(Length x, Length y, Length z);
